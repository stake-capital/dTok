            ...
            balanceDisplay = (
              <div>
                ...
                <div style={{width:"100%",padding:"5%",textAlign:'center',fontSize:22}}>
                  <iframe width="640" height="360" src="https://media.livepeer.org/embed?aspectRatio=16%3A9&maxWidth=100%25&url=https%3A%2F%2Fingest1-rinkeby-distro.livepeer.org%2Fstream%2Fcurrent.m3u8" allowfullscreen></iframe>
                </div>
